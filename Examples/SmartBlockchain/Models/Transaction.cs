...
/// <summary>
/// Represents a cryptographically verifiable Smart Contract invocation.
/// </summary>
public class Transaction
{
    ...
    /// <summary>
    /// Generates the deterministic format that must be hashed: Sender->ContractCode
    /// </summary>
    public string GetSignableData()
    {
        return $"{Sender}->{ContractCode}";
    }
